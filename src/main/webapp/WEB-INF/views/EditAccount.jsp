      ...
      <nav class="mt-2">
        <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
          ...
          <li class="nav-item menu-open">
            ...
            <ul class="nav nav-treeview">
              <li class="nav-item">
                <a href="manageaccount" class="nav-link active">
                  <i class="far fa-circle nav-icon"></i>
                  <p>Add Account</p>
                </a>
              </li>
  ...
  <div class="content-wrapper" style="min-height: 1345.52px;">
    ...
    <section class="content" >
      <div class="container-fluid">
        ...
        <div class="card card-default">
          ...
          <div class="card-body">
          <form action="updateaccount" method="post" class="mb-4">
    ...
    <div class="col-md-6">
        <div class="form-group mb-3">
            ...
            <input type="text" name="accountTitle" value="${account.accountTitle }" class="form-control" required>
        </div>
        
        <div class="form-group mb-3">
            <label class="form-label">Description:</label>
            <textarea name="description" class="form-control" id="myTextarea" required>
    ...
    <div class="col-md-6">
        <div class="form-group mb-3">
            ...
            <input type="number" min="1" step="0.01" name="accountAmount" value="${account.accountAmount }" class="form-control" required>
        </div>
...
<script>
  ...
  <script>
    document.getElementById("myTextarea").value = "${account.description}";
</script>
