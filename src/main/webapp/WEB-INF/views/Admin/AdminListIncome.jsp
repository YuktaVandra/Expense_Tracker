        ...
        <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
          ...
          <li class="nav-item menu-open">
            ...
            <ul class="nav nav-treeview">
              ...
              <li class="nav-item">
                <a href="adminlistincome" class="nav-link active">
                  <i class="far fa-circle nav-icon"></i>
                  <p>List of Income</p>
                </a>
              </li>
  ...
  <div class="content-wrapper">
    ...
    <section class="content-header">
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-6">
            <h1>Income DataTable</h1>
          </div>
          <div class="col-sm-6">
            <ol class="breadcrumb float-sm-right">
              <li class="breadcrumb-item"><a href="admindashboard">Home</a></li>
              <li class="breadcrumb-item active">Income DataTable</li>
            </ol>
          </div>
        </div>
      </div><!-- /.container-fluid -->
...
<th>User Last Name</th>
                  ...
                  <td><a href="adminviewincome?incomeId=${m[0] }"><i class="fas fa-eye"></i> </a> | <a href="admindeleteincome?incomeId=${m[0] }"><i class="fa-solid fa-trash"></i></a> </td>
                  </tr> 
                  </c:forEach>  
                  </tbody>
                  <tfoot>
