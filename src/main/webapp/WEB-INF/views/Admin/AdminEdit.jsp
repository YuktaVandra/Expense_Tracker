...
<%@ page language="java" contentType="text/html; charset=UTF-8"
 ...
 <head>
   ...
   <link rel="stylesheet" href="dist/css/custom-profile.css">
  ...
  /* Make breadcrumb smaller and more subtle */
  .breadcrumb-item a {
    color: #6c757d;
  }
  ...
  <aside class="main-sidebar sidebar-dark-primary elevation-4">
    ...
    <div class="sidebar">
      ...
      <div class="user-panel mt-3 pb-3 mb-3 d-flex">
        ...
        <div class="info">
          <a href="adminedit?userId=${user.userId }" class="d-block">${user.firstName} ${user.lastName }</a>
           ...
           <div class="col-md-3">
             ...
             <div class="card card-primary card-outline">
               <div class="card-body box-profile">
                 ...
                 <p class="text-muted text-center">${user.cityName }, ${user.stateName }</p>
