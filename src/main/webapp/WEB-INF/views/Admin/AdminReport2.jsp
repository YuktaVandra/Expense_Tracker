...
<head>
  ...
  <title>Report 2 (This Month's Total Transaction Count (income + expenses))</title>
  ...
  <aside class="main-sidebar sidebar-dark-primary elevation-4">
    ...
    <div class="sidebar">
      ...
      <ul class="nav nav-treeview">
              ...
              <li class="nav-item">
                <a href="adminreport2" class="nav-link active">
                  <i class="far fa-circle nav-icon"></i>
                  <p>Report 2</p>
                </a>
              </li>
  ...
  <div class="content-wrapper">
    ...
    <section class="content-header">
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-6">
            <h1>This Month's Total Transaction Count (income + expenses)</h1>
          </div>
          <div class="col-sm-6">
            <ol class="breadcrumb float-sm-right">
              <li class="breadcrumb-item"><a href="admindashboard">Home</a></li>
              <li class="breadcrumb-item active">This Month's Total Transaction Count (income + expenses)</li>
            </ol>
          </div>
        </div>
      </div><!-- /.container-fluid -->
            ...
            <div class="card">
              ...
              <div class="card-body">
                <table id="example1" class="table table-bordered table-striped">
                  ...
                  <tbody>
                  <tr>
                  <td>${thisMonthTotalCount }&#x20B9</td>
                  </tr>
