        ...
        <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
          ...
          <li class="nav-item menu-open">
            ...
            <ul class="nav nav-treeview">
              ...
              <li class="nav-item">
                <a href="adminlistsubcategory" class="nav-link active">
                  <i class="far fa-circle nav-icon"></i>
...
<th>Action</th>
				 ...
				 <td>${m.lastName}</td>
				 <td>${m.email}</td>
                  <td><a href="adminviewsubcategory?subcategoryId=${m.subcategoryId }"><i class="fas fa-eye"></i> </a> | <a href="admindeletesubcategory?subcategoryId=${m.subcategoryId }"><i class="fa-solid fa-trash"></i></a> </td>
                  </tr> 
                  </c:forEach>  
                  </tbody>
                  <tfoot>
