        ...
        <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
          ...
          <li class="nav-item ">
           ...
           <li class="nav-item menu-open">
            ...
            <ul class="nav nav-treeview">
              <li class="nav-item">
                <a href="manageexpense" class="nav-link active">
                  <i class="far fa-circle nav-icon"></i>
                  <p>Add Expenses</p>
                </a>
              </li>
  ...
  <div class="content-wrapper" style="min-height: 1345.52px;">
    ...
    <section class="content" >
      <div class="container-fluid">
        ...
        <div class="card card-default">
          ...
          <div class="card-body">
          <form action="updateexpense" method="post" class="mb-4">
    ...
    <div class="col-md-6">
        <div class="form-group mb-3">
            ...
            <input type="text" name="expenseTitle" value="${expense.expenseTitle }" class="form-control" required>
        </div>
...
<div class="form-group mb-3">
    ...
    <div class="col-md-6">
        <div class="form-group mb-3">
            ...
            <input type="number" min="1" step="0.01" name="expenseAmount" value="${expense.expenseAmount }" class="form-control" required>
        </div>
        ...
        <input type="date" name="transactionDate" value="${expense.transactionDate }" class="form-control"  required>
...
<script>
  ...
  <script>
    document.getElementById("myTextarea").value = "${expense.description}";
</script>
