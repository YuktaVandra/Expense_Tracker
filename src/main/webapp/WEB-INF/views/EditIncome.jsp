      ...
      <nav class="mt-2">
        <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
          ...
          <li class="nav-item menu-open">
            ...
            <ul class="nav nav-treeview">
              <li class="nav-item">
                <a href="manageincome" class="nav-link active">
                  <i class="far fa-circle nav-icon"></i>
                  <p>Add Income</p>
                </a>
              </li>
  ...
  <div class="content-wrapper" style="min-height: 1345.52px;">
    ...
    <section class="content" >
      <div class="container-fluid">
        ...
        <div class="card card-default">
          ...
          <div class="card-body">
          <form action="updateincome" method="post" class="mb-4">
    ...
    <div class="col-md-6">
        <div class="form-group mb-3">
            ...
            <input type="text" name="incomeTitle" value="${income.incomeTitle }" class="form-control" required>
        </div>
 
<div class="form-group mb-3">
            <label class="form-label">Status:</label>
        <select name="status"  class="form-control" required >
            <option value="${income.status }">${income.status }</option>
...
<div class="form-group mb-3">
            ...
            <textarea name="description" id="myTextarea" class="form-control" required></textarea>
        </div>
        </div>
    ...
    <div class="col-md-6">
        <div class="form-group mb-3">
            ...
            <input type="number" min="1" step="0.01" name="incomeAmount" value="${income.incomeAmount }" class="form-control" required>
        </div>
        ...
        <input type="date" name="transactionDate" value="${income.transactionDate }" class="form-control"  required>
...
<script>
  ...
  <script>
    document.getElementById("myTextarea").value = "${income.description}";
</script>
