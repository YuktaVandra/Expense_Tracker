  ...
  <div class="content-wrapper">
    ...
    <section class="content-header">
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-6">
            <h1>Vendor DataTable</h1>
          </div>
          <div class="col-sm-6">
            <ol class="breadcrumb float-sm-right">
              <li class="breadcrumb-item"><a href="admindashboard">Home</a></li>
              <li class="breadcrumb-item active">Vendor DataTable</li>
            </ol>
          </div>
        </div>
      </div><!-- /.container-fluid -->
...
<th>Action</th>
				  ...
				  <td>${m.firstName}</td>
				  <td>${m.lastName}</td>
                  <td><a href="viewvendor?vendorId=${m.vendorId }"><i class="fas fa-eye"></i></a> | <a href="deletevendor?vendorId=${m.vendorId }"><i class="fa-solid fa-trash"></i></a> |<a href="editvendor?vendorId=${m.vendorId }"> <i class="fas fa-edit"></i></a></td>
                  </tr> 
                  </c:forEach>  
                  </tbody>
                  <tfoot>
