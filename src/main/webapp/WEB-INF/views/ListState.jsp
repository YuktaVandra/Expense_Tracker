...
<th>Action</th>
                  ...
                  <td><a href="viewstate?stateId=${m.stateId }"><i class="fas fa-eye"></i> </a> | <a href="deletestate?stateId=${m.stateId }"><i class="fa-solid fa-trash"></i></a> | <i class="fas fa-edit"></i></td>
                  </tr> 
                  </c:forEach>  
                  </tbody>
                  <tfoot>
